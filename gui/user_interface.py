...
# TODO: Refactor the code => remove now obsolete methods
...
class GUI(__User_Gui):
    ...
    def __init__(self):
        ...
        self.__is_file_type_backup = False
    ...
    def get__is_file_type_backup(self) -> bool:
        """ Return if the backup procedure chosen by the user is file type backup."""
        return self.__is_file_type_backup

    def get_program_params(self) -> tuple:
        """ Return a tuple which contains all the data used by the programm."""
        return (self.get_source_path(), self.get_destin_path(), get__is_file_type_backup())
    ...
    def set__is_file_type_backup(self, new_val: bool):
        """ Set whether or not the backup procedure is file type backup."""
        self.__is_file_type_backup = new_val
